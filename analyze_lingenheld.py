    ...
    try:
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                L'entreprise Groupe Lingenheld se spécialise dans plusieurs domaines, notamment les travaux publics et l'industrie, l'environnement, les travaux spéciaux, et l'aménagement & promotion. 
                 Parmi les services proposés, on trouve le terrassement, la route, la gestion de l'eau & réseaux, les aménagements urbains, la collecte, valorisation et traitement de déchets, la dépollution, le démantèlement industriel, et la promotion immobilière. L'entreprise met également un accent sur l'innovation, le développement durable et la sécurité de ses équipes.
...
df_fusion.to_csv('data/api_data_fusion_lingenheld.csv', index=False)